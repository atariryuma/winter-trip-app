...
export default function LoginView({ onLogin, validatePasscode, yearRange = "2025" }) {
    ...
    return (
        <div className="min-h-screen w-full flex bg-white dark:bg-slate-900">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 text-white items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-lg text-center lg:text-left">
                    ...
                    <p className="text-xl text-blue-100 font-light tracking-wide mb-8">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-[#F0F2F5] dark:bg-slate-900 lg:bg-white lg:dark:bg-slate-900 relative">
                ...
                <div className="lg:hidden absolute inset-0 bg-gradient-to-br from-blue-600 to-indigo-800 z-0"></div>
                ...
                <div className={`w-full max-w-sm bg-white/90 lg:bg-white dark:bg-slate-800 lg:dark:bg-slate-800 backdrop-blur-xl lg:backdrop-blur-none rounded-3xl p-8 lg:p-12 shadow-2xl lg:shadow-none border border-white/20 lg:border-none z-10 transition-all duration-300 ${shake ? 'animate-shake' : ''}`}>
                    ...
                    <div className="lg:hidden text-center mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Winter Journey</h2>
                    </div>
                        ...
                        <div>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <Lock className={`h-5 w-5 transition-colors ${error ? 'text-red-400' : 'text-gray-400 group-focus-within:text-blue-500'}`} />
                                </div>
                                <input
                                    type="password"
                                    inputMode="numeric"

...
const MapView = ({ mapUrl, itinerary }) => {
    ...
    return (
        <div className="pt-4 space-y-4">
            <div className="bg-white dark:bg-slate-700 rounded-2xl p-2 shadow-sm border border-gray-100 dark:border-slate-600 overflow-hidden mb-6">
                {mapUrl ? (
                    <div className="relative">
                        <img src={mapUrl} alt="Trip Map" loading="lazy" className="w-full h-auto object-cover rounded-xl bg-gray-100 dark:bg-slate-600 min-h-[200px]" />
                    ...
                    <div className="w-full h-48 bg-gray-50 dark:bg-slate-600 rounded-xl flex items-center justify-center text-gray-400 dark:text-slate-400 flex-col gap-2 border-2 border-dashed border-gray-200 dark:border-slate-500">
            ...
            <div className="space-y-4">
                ...
                {markers.map((m, i) => (
                    <a
                        ...
                        className="flex items-center justify-between bg-white dark:bg-slate-700 p-5 rounded-xl shadow-sm border border-gray-100 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-600 transition active:scale-[0.98]"
                    >

        ...
        <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center bg-black/50 p-0 md:p-4" onClick={onClose}>
            <div className="bg-white w-full max-w-lg rounded-t-3xl md:rounded-3xl shadow-2xl flex flex-col max-h-[85vh]" onClick={e => e.stopPropagation()}>
                <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <button onClick={onClose} aria-label="閉じる" className="p-2 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"><X size={20} className="text-gray-500" /></button>
                </div>
                ...
                <div className="p-4 border-t border-gray-100 flex gap-3">
                    {item && onDelete && (<button onClick={() => onDelete(item.id)} aria-label="削除" className="p-3 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500"><Trash2 size={20} /></button>)}

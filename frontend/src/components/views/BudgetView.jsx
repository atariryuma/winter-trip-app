...
import { DollarSign, Target, TrendingUp, Wallet, PlusCircle, X, Check, AlertCircle, User, Edit2 } from 'lucide-react';
                        ...
                        <div className="p-4 overflow-y-auto space-y-5 flex-1">
                            ...
                            {selectedEventId && (
                                <div className="animate-in fade-in slide-in-from-bottom-2">
                                    <div className="text-xs font-bold text-gray-500 uppercase mb-2 flex items-center gap-2">
                                        <span className="w-5 h-5 bg-blue-500 text-white rounded-full flex items-center justify-center text-[10px]">2</span>
                                        金額を選択
                                    </div>
                            ...
                            {selectedEventId && finalAmount > 0 && (
                                <div className="animate-in fade-in slide-in-from-bottom-2">
                                    <div className="text-xs font-bold text-gray-500 uppercase mb-2 flex items-center gap-2">
                                        <span className="w-5 h-5 bg-blue-500 text-white rounded-full flex items-center justify-center text-[10px]">3</span>
                                        支払った人
                                    </div>
